...
exports.BatchAnalyzeRequest = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, baseBatchAnalyzeRequest);
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseBatchAnalyzeRequest);
        message.analyzeSpecs = ((_a = object.analyzeSpecs) !== null && _a !== void 0 ? _a : []).map((e) => exports.AnalyzeSpec.fromJSON(e));
        message.folderId =
    ...
    fromPartial(object) {
        ...
        const message = Object.assign({}, baseBatchAnalyzeRequest);
        message.analyzeSpecs =
            ((_a = object.analyzeSpecs) === null || _a === void 0 ? void 0 : _a.map((e) => exports.AnalyzeSpec.fromPartial(e))) || [];
...
exports.AnalyzeSpec = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseAnalyzeSpec);
        message.features = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object) {
        ...
        message.signature =
            object.signature !== undefined && object.signature !== null
                ...
                : undefined;
        message.features = ((_a = object.features) !== null && _a !== void 0 ? _a : []).map((e) => exports.Feature.fromJSON(e));
        message.mimeType =
    ...
    fromPartial(object) {
        ...
        message.signature = (_b = object.signature) !== null && _b !== void 0 ? _b : undefined;
        message.features =
            ((_c = object.features) === null || _c === void 0 ? void 0 : _c.map((e) => exports.Feature.fromPartial(e))) || [];
...
exports.Feature = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseFeature);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.classificationConfig = exports.FeatureClassificationConfig.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.textDetectionConfig = exports.FeatureTextDetectionConfig.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        message.classificationConfig =
            object.classificationConfig !== undefined &&
                ...
                ? exports.FeatureClassificationConfig.fromJSON(object.classificationConfig)
                : undefined;
        message.textDetectionConfig =
            object.textDetectionConfig !== undefined &&
                object.textDetectionConfig !== null
                ? exports.FeatureTextDetectionConfig.fromJSON(object.textDetectionConfig)
                : undefined;
        return message;
    },
    toJSON(message) {
...
exports.FeatureClassificationConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseFeatureClassificationConfig);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.FeatureTextDetectionConfig = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseFeatureTextDetectionConfig);
    ...
    fromPartial(object) {
        var _a, _b;
        const message = Object.assign({}, baseFeatureTextDetectionConfig);
        message.languageCodes = ((_a = object.languageCodes) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
...
exports.BatchAnalyzeResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseBatchAnalyzeResponse);
        message.results = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseBatchAnalyzeResponse);
        message.results = ((_a = object.results) !== null && _a !== void 0 ? _a : []).map((e) => exports.AnalyzeResult.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        const message = Object.assign({}, baseBatchAnalyzeResponse);
        message.results =
            ((_a = object.results) === null || _a === void 0 ? void 0 : _a.map((e) => exports.AnalyzeResult.fromPartial(e))) || [];
        return message;
    },
};
...
exports.AnalyzeResult = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseAnalyzeResult);
        message.results = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseAnalyzeResult);
        message.results = ((_a = object.results) !== null && _a !== void 0 ? _a : []).map((e) => exports.FeatureResult.fromJSON(e));
        message.error =
    ...
    fromPartial(object) {
        ...
        const message = Object.assign({}, baseAnalyzeResult);
        message.results =
            ((_a = object.results) === null || _a === void 0 ? void 0 : _a.map((e) => exports.FeatureResult.fromPartial(e))) || [];
        message.error =
            object.error !== undefined && object.error !== null
...
exports.FeatureResult = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseFeatureResult);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 2:
    ...
    fromJSON(object) {
        ...
        message.textDetection =
            object.textDetection !== undefined && object.textDetection !== null
                ? text_detection_1.TextAnnotation.fromJSON(object.textDetection)
                : undefined;
        message.classification =
            object.classification !== undefined && object.classification !== null
                ? classification_1.ClassAnnotation.fromJSON(object.classification)
                : undefined;
        message.faceDetection =
            object.faceDetection !== undefined && object.faceDetection !== null
                ? face_detection_1.FaceAnnotation.fromJSON(object.faceDetection)
                : undefined;
        message.imageCopySearch =
            object.imageCopySearch !== undefined && object.imageCopySearch !== null
                ? image_copy_search_1.ImageCopySearchAnnotation.fromJSON(object.imageCopySearch)
                : undefined;
        message.error =
            object.error !== undefined && object.error !== null
                ? status_1.Status.fromJSON(object.error)
    ...
    fromPartial(object) {
        ...
        message.textDetection =
            object.textDetection !== undefined && object.textDetection !== null
                ? text_detection_1.TextAnnotation.fromPartial(object.textDetection)
                : undefined;
        message.classification =
            object.classification !== undefined && object.classification !== null
                ? classification_1.ClassAnnotation.fromPartial(object.classification)
                : undefined;
        message.faceDetection =
            object.faceDetection !== undefined && object.faceDetection !== null
                ? face_detection_1.FaceAnnotation.fromPartial(object.faceDetection)
                : undefined;
        message.imageCopySearch =
            object.imageCopySearch !== undefined && object.imageCopySearch !== null
                ? image_copy_search_1.ImageCopySearchAnnotation.fromPartial(object.imageCopySearch)
                : undefined;
        message.error =
            object.error !== undefined && object.error !== null
                ? status_1.Status.fromPartial(object.error)
