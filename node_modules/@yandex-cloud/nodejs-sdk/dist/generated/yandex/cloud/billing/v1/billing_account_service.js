...
exports.GetBillingAccountRequest = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, baseGetBillingAccountRequest);
...
exports.ListBillingAccountsRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseListBillingAccountsRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 2:
...
exports.ListBillingAccountsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseListBillingAccountsResponse);
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseListBillingAccountsResponse);
        message.billingAccounts = ((_a = object.billingAccounts) !== null && _a !== void 0 ? _a : []).map((e) => billing_account_1.BillingAccount.fromJSON(e));
    ...
    fromPartial(object) {
        ...
        const message = Object.assign({}, baseListBillingAccountsResponse);
        message.billingAccounts =
            ((_a = object.billingAccounts) === null || _a === void 0 ? void 0 : _a.map((e) => billing_account_1.BillingAccount.fromPartial(e))) || [];
...
exports.ListBillableObjectBindingsRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseListBillableObjectBindingsRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.ListBillableObjectBindingsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseListBillableObjectBindingsResponse);
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseListBillableObjectBindingsResponse);
        message.billableObjectBindings = ((_a = object.billableObjectBindings) !== null && _a !== void 0 ? _a : []).map((e) => billable_object_1.BillableObjectBinding.fromJSON(e));
        message.nextPageToken =
            object.nextPageToken !== undefined && object.nextPageToken !== null
                ? String(object.nextPageToken)
                : "";
    ...
    fromPartial(object) {
        ...
        const message = Object.assign({}, baseListBillableObjectBindingsResponse);
        message.billableObjectBindings =
            ((_a = object.billableObjectBindings) === null || _a === void 0 ? void 0 : _a.map((e) => billable_object_1.BillableObjectBinding.fromPartial(e))) || [];
        message.nextPageToken = (_b = object.nextPageToken) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
...
exports.BindBillableObjectRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseBindBillableObjectRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        ...
        message.billableObject =
            object.billableObject !== undefined && object.billableObject !== null
                ? billable_object_1.BillableObject.fromJSON(object.billableObject)
                : undefined;
        return message;
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.billableObject =
            object.billableObject !== undefined && object.billableObject !== null
                ? billable_object_1.BillableObject.fromPartial(object.billableObject)
                : undefined;
        return message;
    },
};
...
exports.BindBillableObjectMetadata = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseBindBillableObjectMetadata);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial(object) {
        var _a;
        const message = Object.assign({}, baseBindBillableObjectMetadata);
        message.billableObjectId = (_a = object.billableObjectId) !== null && _a !== void 0 ? _a : "";
        return message;
    },
};
