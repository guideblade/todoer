...
export declare const ListOriginGroupsResponse: {
    ...
    fromPartial<I extends {
        ...
        originGroups?: ({
            ...
            } & Record<Exclude<keyof I["originGroups"][number]["origins"][number], "$type" | "id" | "enabled" | "originGroupId" | "source" | "backup" | "meta">, never>)[] & Record<Exclude<keyof I["originGroups"][number]["origins"], "$type" | keyof {
                id?: number | undefined;
                enabled?: boolean | undefined;
                originGroupId?: number | undefined;
                source?: string | undefined;
        ...
        } & Record<Exclude<keyof I["originGroups"][number], "$type" | "id" | "name" | "folderId" | "useNext" | "origins">, never>)[] & Record<Exclude<keyof I["originGroups"], "$type" | keyof {
            id?: number | undefined;
            name?: string | undefined;
            folderId?: string | undefined;
            useNext?: boolean | undefined;
...
export declare const CreateOriginGroupRequest: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["origins"][number], "$type" | "enabled" | "source" | "backup" | "meta">, never>)[] & Record<Exclude<keyof I["origins"], "$type" | keyof {
            enabled?: boolean | undefined;
            source?: string | undefined;
            backup?: boolean | undefined;
            meta?: {
    ...
    } & Record<Exclude<keyof I, "$type" | "name" | "folderId" | "useNext" | "origins">, never>>(object: I): CreateOriginGroupRequest;
};
