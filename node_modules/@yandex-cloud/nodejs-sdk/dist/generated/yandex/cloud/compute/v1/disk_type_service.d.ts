...
export declare const GetDiskTypeRequest: {
    ...
    fromPartial<I extends {
        ...
        diskTypeId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "diskTypeId">, never>>(object: I): GetDiskTypeRequest;
};
export declare const ListDiskTypesRequest: {
    ...
    fromPartial<I extends {
        ...
        pageSize?: number | undefined;
        pageToken?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken">, never>>(object: I): ListDiskTypesRequest;
};
export declare const ListDiskTypesResponse: {
    ...
    fromPartial<I extends {
        ...
        diskTypes?: ({
            ...
            description?: string | undefined;
            id?: string | undefined;
            zoneIds?: (string[] & string[] & Record<Exclude<keyof I["diskTypes"][number]["zoneIds"], "$type" | keyof string[]>, never>) | undefined;
        } & Record<Exclude<keyof I["diskTypes"][number], "$type" | "description" | "id" | "zoneIds">, never>)[] & Record<Exclude<keyof I["diskTypes"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            zoneIds?: string[] | undefined;
        }[]>, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "nextPageToken" | "diskTypes">, never>>(object: I): ListDiskTypesResponse;
};
...
export declare const DiskTypeServiceClient: {
    new (address: string, credentials: ChannelCredentials, options?: Partial<ChannelOptions> | undefined): DiskTypeServiceClient;
