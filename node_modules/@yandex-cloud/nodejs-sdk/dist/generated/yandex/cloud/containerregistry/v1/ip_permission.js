...
exports.IpPermission = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, baseIpPermission);
    ...
    fromJSON(object) {
        ...
        message.action =
            object.action !== undefined && object.action !== null
                ...
                : 0;
        message.ip =
            object.ip !== undefined && object.ip !== null ? String(object.ip) : "";
        return message;
    },
    toJSON(message) {
        const obj = {};
...
exports.IpPermissionDelta = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseIpPermissionDelta);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        ...
        message.ipPermission =
            object.ipPermission !== undefined && object.ipPermission !== null
                ? exports.IpPermission.fromJSON(object.ipPermission)
                : undefined;
        return message;
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.ipPermission =
            object.ipPermission !== undefined && object.ipPermission !== null
                ? exports.IpPermission.fromPartial(object.ipPermission)
                : undefined;
        return message;
    },
};
