...
exports.NodeServiceClient = exports.NodeServiceService = exports.AliasExecutionResponse = exports.AliasExecutionRequest = exports.NodeExecutionResponse = exports.NodeExecutionRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.AliasExecutionRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseAliasExecutionRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromPartial(object) {
        ...
        const message = Object.assign({}, baseAliasExecutionRequest);
        message.folderId = (_a = object.folderId) !== null && _a !== void 0 ? _a : "";
        message.aliasName = (_b = object.aliasName) !== null && _b !== void 0 ? _b : "";
        message.input = (_c = object.input) !== null && _c !== void 0 ? _c : undefined;
        return message;
    },
};
typeRegistry_1.messageTypeRegistry.set(exports.AliasExecutionRequest.$type, exports.AliasExecutionRequest);
const baseAliasExecutionResponse = {
    $type: "yandex.cloud.datasphere.v1.AliasExecutionResponse",
};
exports.AliasExecutionResponse = {
    $type: "yandex.cloud.datasphere.v1.AliasExecutionResponse",
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.output !== undefined) {
            struct_1.Struct.encode(struct_1.Struct.wrap(message.output), writer.uint32(10).fork()).ldelim();
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseAliasExecutionResponse);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
typeRegistry_1.messageTypeRegistry.set(exports.AliasExecutionResponse.$type, exports.AliasExecutionResponse);
...
exports.NodeServiceService = {
    ...
    executeAlias: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(exports.AliasExecutionRequest.encode(value).finish()),
        requestDeserialize: (value) => exports.AliasExecutionRequest.decode(value),
        responseSerialize: (value) => Buffer.from(exports.AliasExecutionResponse.encode(value).finish()),
        responseDeserialize: (value) => exports.AliasExecutionResponse.decode(value),
    },
};
