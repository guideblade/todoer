...
export declare const GetRoleRequest: {
    ...
    fromPartial<I extends {
        ...
        roleId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "roleId">, never>>(object: I): GetRoleRequest;
};
export declare const ListRolesRequest: {
    ...
    fromPartial<I extends {
        ...
        pageToken?: string | undefined;
        filter?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "pageSize" | "pageToken" | "filter">, never>>(object: I): ListRolesRequest;
};
export declare const ListRolesResponse: {
    ...
    fromPartial<I extends {
        ...
        roles?: ({
            ...
            description?: string | undefined;
            id?: string | undefined;
        } & Record<Exclude<keyof I["roles"][number], "$type" | "description" | "id">, never>)[] & Record<Exclude<keyof I["roles"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
        }[]>, never>) | undefined;
    } & Record<Exclude<keyof I, "$type" | "nextPageToken" | "roles">, never>>(object: I): ListRolesResponse;
};
...
export declare const RoleServiceClient: {
    new (address: string, credentials: ChannelCredentials, options?: Partial<ChannelOptions> | undefined): RoleServiceClient;
