...
export declare const ListServiceAccountsResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["serviceAccounts"][number], "$type" | "description" | "id" | "name" | "createdAt" | "folderId" | "labels">, never>)[] & Record<Exclude<keyof I["serviceAccounts"], "$type" | keyof {
            description?: string | undefined;
            id?: string | undefined;
            name?: string | undefined;
            createdAt?: Date | undefined;
...
export declare const CreateServiceAccountRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "description" | "name" | "folderId" | "labels">, never>>(object: I): CreateServiceAccountRequest;
};
