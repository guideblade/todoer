...
export declare const PublishDeviceDataRequest: {
    ...
    fromPartial<I extends {
        ...
        topic?: string | undefined;
        deviceId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "data" | "topic" | "deviceId">, never>>(object: I): PublishDeviceDataRequest;
};
export declare const PublishDeviceDataResponse: {
    ...
    fromPartial<I extends {} & {} & Record<Exclude<keyof I, "$type">, never>>(_: I): PublishDeviceDataResponse;
};
...
export declare const DeviceDataServiceClient: {
    new (address: string, credentials: ChannelCredentials, options?: Partial<ChannelOptions> | undefined): DeviceDataServiceClient;
