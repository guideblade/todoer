...
export declare const PublishRegistryDataRequest: {
    ...
    fromPartial<I extends {
        ...
        registryId?: string | undefined;
        topic?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "data" | "registryId" | "topic">, never>>(object: I): PublishRegistryDataRequest;
};
export declare const PublishRegistryDataResponse: {
    ...
    fromPartial<I extends {} & {} & Record<Exclude<keyof I, "$type">, never>>(_: I): PublishRegistryDataResponse;
};
...
export declare const RegistryDataServiceClient: {
    new (address: string, credentials: ChannelCredentials, options?: Partial<ChannelOptions> | undefined): RegistryDataServiceClient;
