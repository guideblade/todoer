...
import { UsageRecord, AcceptedUsageRecord, RejectedUsageRecord } from "../../../../../yandex/cloud/marketplace/metering/v1/usage_record";
...
export declare const WriteImageProductUsageResponse: {
    ...
    fromPartial<I extends {
        ...
        rejected?: {
            uuid?: string | undefined;
            reason?: import("../../../../../yandex/cloud/marketplace/metering/v1/usage_record").RejectedUsageRecord_Reason | undefined;
        }[] | undefined;
    } & {
        accepted?: ({
            uuid?: string | undefined;
