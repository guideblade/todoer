...
import { ResourcePreset_Type, ResourcePreset } from "../../../../../yandex/cloud/mdb/greenplum/v1/resource_preset";
...
export declare const GetResourcePresetRequest: {
    ...
    fromPartial<I extends {
        ...
        type?: ResourcePreset_Type | undefined;
        resourcePresetId?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "type" | "resourcePresetId">, never>>(object: I): GetResourcePresetRequest;
};
export declare const ListResourcePresetsRequest: {
    ...
    fromPartial<I extends {
        ...
        pageSize?: number | undefined;
        pageToken?: string | undefined;
    } & Record<Exclude<keyof I, "$type" | "type" | "pageSize" | "pageToken">, never>>(object: I): ListResourcePresetsRequest;
};
export declare const ListResourcePresetsResponse: {
    ...
    fromPartial<I extends {
        ...
        resourcePresets?: ({
            ...
            memory?: number | undefined;
            cores?: number | undefined;
            diskTypeIds?: (string[] & string[] & Record<Exclude<keyof I["resourcePresets"][number]["diskTypeIds"], "$type" | keyof string[]>, never>) | undefined;
            hostCountDivider?: number | undefined;
            maxSegmentInHostCount?: number | undefined;
        } & Record<Exclude<keyof I["resourcePresets"][number], "$type" | "id" | "type" | "zoneIds" | "memory" | "cores" | "diskTypeIds" | "hostCountDivider" | "maxSegmentInHostCount">, never>)[] & Record<Exclude<keyof I["resourcePresets"], "$type" | keyof {
            id?: string | undefined;
            type?: ResourcePreset_Type | undefined;
            zoneIds?: string[] | undefined;
            memory?: number | undefined;
