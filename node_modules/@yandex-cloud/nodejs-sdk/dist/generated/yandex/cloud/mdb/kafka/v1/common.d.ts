...
export declare enum SaslMechanism {
    SASL_MECHANISM_UNSPECIFIED = 0,
    SASL_MECHANISM_SCRAM_SHA_256 = 1,
    SASL_MECHANISM_SCRAM_SHA_512 = 2,
    UNRECOGNIZED = -1
}
export declare function saslMechanismFromJSON(object: any): SaslMechanism;
export declare function saslMechanismToJSON(object: SaslMechanism): string;
