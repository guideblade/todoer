...
exports.saslMechanismToJSON = exports.saslMechanismFromJSON = exports.SaslMechanism = exports.compressionTypeToJSON = exports.compressionTypeFromJSON = exports.CompressionType = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (SaslMechanism) {
    SaslMechanism[SaslMechanism["SASL_MECHANISM_UNSPECIFIED"] = 0] = "SASL_MECHANISM_UNSPECIFIED";
    SaslMechanism[SaslMechanism["SASL_MECHANISM_SCRAM_SHA_256"] = 1] = "SASL_MECHANISM_SCRAM_SHA_256";
    SaslMechanism[SaslMechanism["SASL_MECHANISM_SCRAM_SHA_512"] = 2] = "SASL_MECHANISM_SCRAM_SHA_512";
    SaslMechanism[SaslMechanism["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(SaslMechanism = exports.SaslMechanism || (exports.SaslMechanism = {}));
function saslMechanismFromJSON(object) {
    switch (object) {
        case 0:
...
exports.saslMechanismFromJSON = saslMechanismFromJSON;
function saslMechanismToJSON(object) {
    switch (object) {
...
exports.saslMechanismToJSON = saslMechanismToJSON;
