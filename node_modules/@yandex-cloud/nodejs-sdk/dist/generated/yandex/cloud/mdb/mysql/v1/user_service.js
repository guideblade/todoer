...
exports.UpdateUserRequest = {
    ...
    fromJSON(object) {
        ...
        message.globalPermissions = ((_b = object.globalPermissions) !== null && _b !== void 0 ? _b : []).map((e) => (0, user_1.globalPermissionFromJSON)(e));
        message.connectionLimits =
            object.connectionLimits !== undefined && object.connectionLimits !== null
                ? user_1.ConnectionLimits.fromJSON(object.connectionLimits)
                : undefined;
        message.authenticationPlugin =
            object.authenticationPlugin !== undefined &&
                object.authenticationPlugin !== null
                ? (0, user_1.authPluginFromJSON)(object.authenticationPlugin)
                : 0;
        return message;
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.globalPermissions = ((_e = object.globalPermissions) === null || _e === void 0 ? void 0 : _e.map((e) => e)) || [];
        message.connectionLimits =
            object.connectionLimits !== undefined && object.connectionLimits !== null
                ? user_1.ConnectionLimits.fromPartial(object.connectionLimits)
                : undefined;
        message.authenticationPlugin = (_f = object.authenticationPlugin) !== null && _f !== void 0 ? _f : 0;
        return message;
    },
};
