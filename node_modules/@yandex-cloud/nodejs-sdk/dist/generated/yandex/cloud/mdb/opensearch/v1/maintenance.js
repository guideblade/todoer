...
exports.MaintenanceOperation = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.latestMaintenanceTime !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.latestMaintenanceTime), writer.uint32(26).fork()).ldelim();
        }
        if (message.nextMaintenanceWindowTime !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.nextMaintenanceWindowTime), writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.latestMaintenanceTime = fromTimestamp(timestamp_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                case 4:
                    message.nextMaintenanceWindowTime = fromTimestamp(timestamp_1.Timestamp.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromPartial(object) {
        ...
        message.latestMaintenanceTime = (_c = object.latestMaintenanceTime) !== null && _c !== void 0 ? _c : undefined;
        message.nextMaintenanceWindowTime =
            (_d = object.nextMaintenanceWindowTime) !== null && _d !== void 0 ? _d : undefined;
        return message;
    },
};
