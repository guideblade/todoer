...
exports.Postgresqlhostconfig101c = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, basePostgresqlhostconfig101c);
    ...
    fromJSON(object) {
        ...
        message.logMinMessages =
            object.logMinMessages !== undefined && object.logMinMessages !== null
                ? postgresqlhostconfig101c_LogLevelFromJSON(object.logMinMessages)
                : 0;
        ...
        message.byteaOutput =
            object.byteaOutput !== undefined && object.byteaOutput !== null
                ? postgresqlhostconfig101c_ByteaOutputFromJSON(object.byteaOutput)
                : 0;
        message.xmlbinary =
            object.xmlbinary !== undefined && object.xmlbinary !== null
                ? postgresqlhostconfig101c_XmlBinaryFromJSON(object.xmlbinary)
                : 0;
        message.xmloption =
            object.xmloption !== undefined && object.xmloption !== null
                ? postgresqlhostconfig101c_XmlOptionFromJSON(object.xmloption)
                : 0;
    ...
    toJSON(message) {
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode = postgresqlhostconfig101c_ForceParallelModeToJSON(message.forceParallelMode));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity = postgresqlhostconfig101c_LogErrorVerbosityToJSON(message.logErrorVerbosity));
