...
exports.PostgresqlConfig16 = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, basePostgresqlConfig16);
    ...
    fromJSON(object) {
        ...
        message.walLevel =
            object.walLevel !== undefined && object.walLevel !== null
                ? postgresqlConfig16_WalLevelFromJSON(object.walLevel)
                : 0;
        message.synchronousCommit =
            object.synchronousCommit !== undefined &&
                object.synchronousCommit !== null
                ? postgresqlConfig16_SynchronousCommitFromJSON(object.synchronousCommit)
                : 0;
        ...
        message.constraintExclusion =
            object.constraintExclusion !== undefined &&
                ...
                ? postgresqlConfig16_ConstraintExclusionFromJSON(object.constraintExclusion)
                : 0;
        ...
        message.logErrorVerbosity =
            object.logErrorVerbosity !== undefined &&
                ...
                ? postgresqlConfig16_LogErrorVerbosityFromJSON(object.logErrorVerbosity)
                : 0;
        ...
        message.logStatement =
            object.logStatement !== undefined && object.logStatement !== null
                ? postgresqlConfig16_LogStatementFromJSON(object.logStatement)
                : 0;
        ...
        message.defaultTransactionIsolation =
            object.defaultTransactionIsolation !== undefined &&
                ...
                ? postgresqlConfig16_TransactionIsolationFromJSON(object.defaultTransactionIsolation)
                : 0;
        ...
        message.byteaOutput =
            object.byteaOutput !== undefined && object.byteaOutput !== null
                ? postgresqlConfig16_ByteaOutputFromJSON(object.byteaOutput)
                : 0;
        message.xmlbinary =
            object.xmlbinary !== undefined && object.xmlbinary !== null
                ? postgresqlConfig16_XmlBinaryFromJSON(object.xmlbinary)
                : 0;
        message.xmloption =
            object.xmloption !== undefined && object.xmloption !== null
                ? postgresqlConfig16_XmlOptionFromJSON(object.xmloption)
                : 0;
        ...
        message.backslashQuote =
            object.backslashQuote !== undefined && object.backslashQuote !== null
                ? postgresqlConfig16_BackslashQuoteFromJSON(object.backslashQuote)
                : 0;
        ...
        message.planCacheMode =
            object.planCacheMode !== undefined && object.planCacheMode !== null
                ? postgresqlConfig16_PlanCacheModeFromJSON(object.planCacheMode)
                : 0;
        ...
        message.effectiveCacheSize =
            object.effectiveCacheSize !== undefined &&
                ...
                : undefined;
        message.sharedPreloadLibraries = ((_a = object.sharedPreloadLibraries) !== null && _a !== void 0 ? _a : []).map((e) => postgresqlConfig16_SharedPreloadLibrariesFromJSON(e));
        ...
        message.pgHintPlanDebugPrint =
            object.pgHintPlanDebugPrint !== undefined &&
                ...
                ? postgresqlConfig16_PgHintPlanDebugPrintFromJSON(object.pgHintPlanDebugPrint)
                : 0;
        message.pgHintPlanMessageLevel =
            object.pgHintPlanMessageLevel !== undefined &&
                object.pgHintPlanMessageLevel !== null
                ? postgresqlConfig16_LogLevelFromJSON(object.pgHintPlanMessageLevel)
                : 0;
    ...
    toJSON(message) {
        ...
        message.walLevel !== undefined &&
            (obj.walLevel = postgresqlConfig16_WalLevelToJSON(message.walLevel));
        message.synchronousCommit !== undefined &&
            (obj.synchronousCommit = postgresqlConfig16_SynchronousCommitToJSON(message.synchronousCommit));
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion = postgresqlConfig16_ConstraintExclusionToJSON(message.constraintExclusion));
        ...
        message.debugParallelQuery !== undefined &&
            (obj.debugParallelQuery = postgresqlConfig16_DebugParallelQueryToJSON(message.debugParallelQuery));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlConfig16_LogLevelToJSON(message.clientMinMessages));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlConfig16_LogLevelToJSON(message.logMinMessages));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlConfig16_LogLevelToJSON(message.logMinErrorStatement));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity = postgresqlConfig16_LogErrorVerbosityToJSON(message.logErrorVerbosity));
        message.logLockWaits !== undefined &&
            (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlConfig16_LogStatementToJSON(message.logStatement));
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation =
                postgresqlConfig16_TransactionIsolationToJSON(message.defaultTransactionIsolation));
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlConfig16_ByteaOutputToJSON(message.byteaOutput));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlConfig16_XmlBinaryToJSON(message.xmlbinary));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlConfig16_XmlOptionToJSON(message.xmloption));
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlConfig16_BackslashQuoteToJSON(message.backslashQuote));
        ...
        message.planCacheMode !== undefined &&
            (obj.planCacheMode = postgresqlConfig16_PlanCacheModeToJSON(message.planCacheMode));
        ...
        if (message.sharedPreloadLibraries) {
            obj.sharedPreloadLibraries = message.sharedPreloadLibraries.map((e) => postgresqlConfig16_SharedPreloadLibrariesToJSON(e));
        }
        else {
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint = postgresqlConfig16_PgHintPlanDebugPrintToJSON(message.pgHintPlanDebugPrint));
        message.pgHintPlanMessageLevel !== undefined &&
            (obj.pgHintPlanMessageLevel = postgresqlConfig16_LogLevelToJSON(message.pgHintPlanMessageLevel));
...
typeRegistry_1.messageTypeRegistry.set(exports.PostgresqlConfig16.$type, exports.PostgresqlConfig16);
const basePostgresqlConfigSet16 = {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16",
};
exports.PostgresqlConfigSet16 = {
    $type: "yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet16",
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.effectiveConfig !== undefined) {
            exports.PostgresqlConfig16.encode(message.effectiveConfig, writer.uint32(10).fork()).ldelim();
        }
        if (message.userConfig !== undefined) {
            exports.PostgresqlConfig16.encode(message.userConfig, writer.uint32(18).fork()).ldelim();
        }
        if (message.defaultConfig !== undefined) {
            exports.PostgresqlConfig16.encode(message.defaultConfig, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, basePostgresqlConfigSet16);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.effectiveConfig = exports.PostgresqlConfig16.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.userConfig = exports.PostgresqlConfig16.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.defaultConfig = exports.PostgresqlConfig16.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.PostgresqlConfig16.fromJSON(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.PostgresqlConfig16.fromJSON(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.PostgresqlConfig16.fromJSON(object.defaultConfig)
                : undefined;
        return message;
    },
    toJSON(message) {
        ...
        message.effectiveConfig !== undefined &&
            (obj.effectiveConfig = message.effectiveConfig
                ? exports.PostgresqlConfig16.toJSON(message.effectiveConfig)
                : undefined);
        message.userConfig !== undefined &&
            (obj.userConfig = message.userConfig
                ? exports.PostgresqlConfig16.toJSON(message.userConfig)
                : undefined);
        message.defaultConfig !== undefined &&
            (obj.defaultConfig = message.defaultConfig
                ? exports.PostgresqlConfig16.toJSON(message.defaultConfig)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.PostgresqlConfig16.fromPartial(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.PostgresqlConfig16.fromPartial(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.PostgresqlConfig16.fromPartial(object.defaultConfig)
                : undefined;
        return message;
    },
};
typeRegistry_1.messageTypeRegistry.set(exports.PostgresqlConfigSet16.$type, exports.PostgresqlConfigSet16);
