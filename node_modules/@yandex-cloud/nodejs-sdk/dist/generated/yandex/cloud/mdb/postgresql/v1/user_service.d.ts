    ...
    fromPartial<I extends {
        ...
        users?: ({
            ...
            settings?: ({
                ...
                catchupTimeout?: number | undefined;
                walSenderTimeout?: number | undefined;
            } & Record<Exclude<keyof I["users"][number]["settings"], "$type" | "logStatement" | "synchronousCommit" | "defaultTransactionIsolation" | "tempFileLimit" | "logMinDurationStatement" | "statementTimeout" | "lockTimeout" | "idleInTransactionSessionTimeout" | "poolMode" | "preparedStatementsPooling" | "catchupTimeout" | "walSenderTimeout">, never>) | undefined;
            deletionProtection?: boolean | undefined;
            permissions?: ({
                databaseName?: string | undefined;
            }[] & ({
        ...
        } & Record<Exclude<keyof I["users"][number], "$type" | "name" | "settings" | "deletionProtection" | "permissions" | "clusterId" | "login" | "connLimit" | "grants">, never>)[] & Record<Exclude<keyof I["users"], "$type" | keyof {
            name?: string | undefined;
            settings?: {
                logStatement?: import("../../../../../yandex/cloud/mdb/postgresql/v1/user").UserSettings_LogStatement | undefined;
                synchronousCommit?: import("../../../../../yandex/cloud/mdb/postgresql/v1/user").UserSettings_SynchronousCommit | undefined;
    ...
    fromPartial<I extends {
        ...
        userSpec?: ({
            ...
            settings?: ({
                ...
                catchupTimeout?: number | undefined;
                walSenderTimeout?: number | undefined;
            } & Record<Exclude<keyof I["userSpec"]["settings"], "$type" | "logStatement" | "synchronousCommit" | "defaultTransactionIsolation" | "tempFileLimit" | "logMinDurationStatement" | "statementTimeout" | "lockTimeout" | "idleInTransactionSessionTimeout" | "poolMode" | "preparedStatementsPooling" | "catchupTimeout" | "walSenderTimeout">, never>) | undefined;
            deletionProtection?: boolean | undefined;
            permissions?: ({
                databaseName?: string | undefined;
            }[] & ({
        ...
        } & Record<Exclude<keyof I["userSpec"], "$type" | "name" | "settings" | "deletionProtection" | "permissions" | "password" | "login" | "connLimit" | "grants">, never>) | undefined;
...
export declare const UpdateUserRequest: {
    ...
    } & Record<Exclude<keyof I, "$type" | "updateMask" | "settings" | "deletionProtection" | "permissions" | "clusterId" | "password" | "login" | "userName" | "connLimit" | "grants">, never>>(object: I): UpdateUserRequest;
};
