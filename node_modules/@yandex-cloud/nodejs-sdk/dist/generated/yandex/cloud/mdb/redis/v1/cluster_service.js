...
exports.CreateClusterRequest = {
    ...
    fromPartial(object) {
        ...
        message.announceHostnames = (_o = object.announceHostnames) !== null && _o !== void 0 ? _o : false;
        return message;
    },
};
...
exports.UpdateClusterRequest = {
    ...
    fromPartial(object) {
        ...
        message.announceHostnames = (_h = object.announceHostnames) !== null && _h !== void 0 ? _h : false;
        return message;
    },
};
...
exports.ConfigSpec = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.redis !== undefined) {
            redis_1.RedisConfig.encode(message.redis, writer.uint32(90).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 11:
                    message.redis = redis_1.RedisConfig.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        message.redis =
            object.redis !== undefined && object.redis !== null
                ? redis_1.RedisConfig.fromJSON(object.redis)
                : undefined;
        return message;
    },
    toJSON(message) {
        ...
        message.redis !== undefined &&
            (obj.redis = message.redis
                ? redis_1.RedisConfig.toJSON(message.redis)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.redis =
            object.redis !== undefined && object.redis !== null
                ? redis_1.RedisConfig.fromPartial(object.redis)
                : undefined;
        return message;
    },
};
