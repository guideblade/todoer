...
exports.Redisconfigset60 = exports.Redisconfig60_ClientOutputBufferLimit = exports.Redisconfig60 = exports.redisconfig60_MaxmemoryPolicyToJSON = exports.redisconfig60_MaxmemoryPolicyFromJSON = exports.Redisconfig60_MaxmemoryPolicy = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.Redisconfig60 = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.clientOutputBufferLimitPubsub !== undefined) {
            exports.Redisconfig60_ClientOutputBufferLimit.encode(message.clientOutputBufferLimitPubsub, writer.uint32(66).fork()).ldelim();
        }
        if (message.clientOutputBufferLimitNormal !== undefined) {
            exports.Redisconfig60_ClientOutputBufferLimit.encode(message.clientOutputBufferLimitNormal, writer.uint32(74).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        const message = Object.assign({}, baseRedisconfig60);
            ...
            switch (tag >>> 3) {
                ...
                case 8:
                    message.clientOutputBufferLimitPubsub =
                        exports.Redisconfig60_ClientOutputBufferLimit.decode(reader, reader.uint32());
                    break;
                case 9:
    ...
    fromJSON(object) {
        ...
        message.clientOutputBufferLimitPubsub =
            object.clientOutputBufferLimitPubsub !== undefined &&
                ...
                ? exports.Redisconfig60_ClientOutputBufferLimit.fromJSON(object.clientOutputBufferLimitPubsub)
                : undefined;
        message.clientOutputBufferLimitNormal =
            object.clientOutputBufferLimitNormal !== undefined &&
                object.clientOutputBufferLimitNormal !== null
                ? exports.Redisconfig60_ClientOutputBufferLimit.fromJSON(object.clientOutputBufferLimitNormal)
                : undefined;
        return message;
    },
    toJSON(message) {
        ...
        message.clientOutputBufferLimitPubsub !== undefined &&
            (obj.clientOutputBufferLimitPubsub = message.clientOutputBufferLimitPubsub
                ? exports.Redisconfig60_ClientOutputBufferLimit.toJSON(message.clientOutputBufferLimitPubsub)
                : undefined);
        message.clientOutputBufferLimitNormal !== undefined &&
            (obj.clientOutputBufferLimitNormal = message.clientOutputBufferLimitNormal
                ? exports.Redisconfig60_ClientOutputBufferLimit.toJSON(message.clientOutputBufferLimitNormal)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.clientOutputBufferLimitPubsub =
            object.clientOutputBufferLimitPubsub !== undefined &&
                object.clientOutputBufferLimitPubsub !== null
                ? exports.Redisconfig60_ClientOutputBufferLimit.fromPartial(object.clientOutputBufferLimitPubsub)
                : undefined;
        message.clientOutputBufferLimitNormal =
            object.clientOutputBufferLimitNormal !== undefined &&
                object.clientOutputBufferLimitNormal !== null
                ? exports.Redisconfig60_ClientOutputBufferLimit.fromPartial(object.clientOutputBufferLimitNormal)
                : undefined;
        return message;
    },
};
typeRegistry_1.messageTypeRegistry.set(exports.Redisconfig60.$type, exports.Redisconfig60);
const baseRedisconfig60_ClientOutputBufferLimit = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig6_0.ClientOutputBufferLimit",
};
exports.Redisconfig60_ClientOutputBufferLimit = {
    $type: "yandex.cloud.mdb.redis.v1.config.RedisConfig6_0.ClientOutputBufferLimit",
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRedisconfig60_ClientOutputBufferLimit);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
typeRegistry_1.messageTypeRegistry.set(exports.Redisconfig60_ClientOutputBufferLimit.$type, exports.Redisconfig60_ClientOutputBufferLimit);
...
exports.Redisconfigset60 = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseRedisconfigset60);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.Redisconfig60.fromJSON(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.Redisconfig60.fromJSON(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.Redisconfig60.fromJSON(object.defaultConfig)
                : undefined;
        return message;
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        ...
        message.effectiveConfig =
            object.effectiveConfig !== undefined && object.effectiveConfig !== null
                ? exports.Redisconfig60.fromPartial(object.effectiveConfig)
                : undefined;
        message.userConfig =
            object.userConfig !== undefined && object.userConfig !== null
                ? exports.Redisconfig60.fromPartial(object.userConfig)
                : undefined;
        message.defaultConfig =
            object.defaultConfig !== undefined && object.defaultConfig !== null
                ? exports.Redisconfig60.fromPartial(object.defaultConfig)
                : undefined;
        return message;
    },
};
