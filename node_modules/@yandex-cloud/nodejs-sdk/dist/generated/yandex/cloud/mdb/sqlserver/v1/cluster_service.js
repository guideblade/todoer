...
exports.CreateClusterRequest = {
    ...
    fromPartial(object) {
        ...
        message.sqlcollation = (_m = object.sqlcollation) !== null && _m !== void 0 ? _m : "";
        message.hostGroupIds = ((_o = object.hostGroupIds) === null || _o === void 0 ? void 0 : _o.map((e) => e)) || [];
        message.serviceAccountId = (_p = object.serviceAccountId) !== null && _p !== void 0 ? _p : "";
        return message;
    },
};
    ...
    fromPartial(object) {
        ...
        message.updateMask =
            object.updateMask !== undefined && object.updateMask !== null
                ? field_mask_1.FieldMask.fromPartial(object.updateMask)
                : undefined;
        message.assignPublicIp = (_b = object.assignPublicIp) !== null && _b !== void 0 ? _b : false;
        return message;
    },
};
...
exports.ConfigSpec = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.sqlserverConfig2017std !== undefined) {
            sqlserver2017_1.SQLServerConfig2017std.encode(message.sqlserverConfig2017std, writer.uint32(66).fork()).ldelim();
        }
        if (message.sqlserverConfig2017ent !== undefined) {
            sqlserver2017_1.SQLServerConfig2017ent.encode(message.sqlserverConfig2017ent, writer.uint32(74).fork()).ldelim();
        }
        if (message.sqlserverConfig2019std !== undefined) {
            sqlserver2019_1.SQLServerConfig2019std.encode(message.sqlserverConfig2019std, writer.uint32(82).fork()).ldelim();
        }
        if (message.sqlserverConfig2019ent !== undefined) {
            sqlserver2019_1.SQLServerConfig2019ent.encode(message.sqlserverConfig2019ent, writer.uint32(90).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.sqlserverConfig2016sp2std = sqlserver2016sp2_1.SQLServerConfig2016sp2std.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.sqlserverConfig2016sp2ent = sqlserver2016sp2_1.SQLServerConfig2016sp2ent.decode(reader, reader.uint32());
                    break;
                case 8:
                    message.sqlserverConfig2017std = sqlserver2017_1.SQLServerConfig2017std.decode(reader, reader.uint32());
                    break;
                case 9:
                    message.sqlserverConfig2017ent = sqlserver2017_1.SQLServerConfig2017ent.decode(reader, reader.uint32());
                    break;
                case 10:
                    message.sqlserverConfig2019std = sqlserver2019_1.SQLServerConfig2019std.decode(reader, reader.uint32());
                    break;
                case 11:
                    message.sqlserverConfig2019ent = sqlserver2019_1.SQLServerConfig2019ent.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        ...
        message.secondaryConnections =
            object.secondaryConnections !== undefined &&
                ...
                ? (0, cluster_1.clusterConfig_SecondaryConnectionsFromJSON)(object.secondaryConnections)
                : 0;
        return message;
    },
    toJSON(message) {
        ...
        message.sqlserverConfig2017std !== undefined &&
            (obj.sqlserverConfig_2017std = message.sqlserverConfig2017std
                ? sqlserver2017_1.SQLServerConfig2017std.toJSON(message.sqlserverConfig2017std)
                : undefined);
        message.sqlserverConfig2017ent !== undefined &&
            (obj.sqlserverConfig_2017ent = message.sqlserverConfig2017ent
                ? sqlserver2017_1.SQLServerConfig2017ent.toJSON(message.sqlserverConfig2017ent)
                : undefined);
        message.sqlserverConfig2019std !== undefined &&
            (obj.sqlserverConfig_2019std = message.sqlserverConfig2019std
                ? sqlserver2019_1.SQLServerConfig2019std.toJSON(message.sqlserverConfig2019std)
                : undefined);
        message.sqlserverConfig2019ent !== undefined &&
            (obj.sqlserverConfig_2019ent = message.sqlserverConfig2019ent
                ? sqlserver2019_1.SQLServerConfig2019ent.toJSON(message.sqlserverConfig2019ent)
                : undefined);
        ...
        message.secondaryConnections !== undefined &&
            (obj.secondaryConnections = (0, cluster_1.clusterConfig_SecondaryConnectionsToJSON)(message.secondaryConnections));
        return obj;
    },
    fromPartial(object) {
        var _a, _b;
        ...
        message.sqlserverConfig2017std =
            object.sqlserverConfig2017std !== undefined &&
                ...
                ? sqlserver2017_1.SQLServerConfig2017std.fromPartial(object.sqlserverConfig2017std)
                : undefined;
        message.sqlserverConfig2017ent =
            object.sqlserverConfig2017ent !== undefined &&
                object.sqlserverConfig2017ent !== null
                ? sqlserver2017_1.SQLServerConfig2017ent.fromPartial(object.sqlserverConfig2017ent)
                : undefined;
        message.sqlserverConfig2019std =
            object.sqlserverConfig2019std !== undefined &&
                object.sqlserverConfig2019std !== null
                ? sqlserver2019_1.SQLServerConfig2019std.fromPartial(object.sqlserverConfig2019std)
                : undefined;
        message.sqlserverConfig2019ent =
            object.sqlserverConfig2019ent !== undefined &&
                object.sqlserverConfig2019ent !== null
                ? sqlserver2019_1.SQLServerConfig2019ent.fromPartial(object.sqlserverConfig2019ent)
                : undefined;
        message.resources =
            object.resources !== undefined && object.resources !== null
