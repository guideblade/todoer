...
import { UserSpec, Permission, User, ServerRole } from "../../../../../yandex/cloud/mdb/sqlserver/v1/user";
...
export declare const ListUsersResponse: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["users"][number], "$type" | "name" | "permissions" | "clusterId" | "serverRoles">, never>)[] & Record<Exclude<keyof I["users"], "$type" | keyof {
            name?: string | undefined;
            permissions?: {
                databaseName?: string | undefined;
                roles?: import("../../../../../yandex/cloud/mdb/sqlserver/v1/user").Permission_Role[] | undefined;
...
export declare const CreateUserRequest: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["userSpec"], "$type" | "name" | "permissions" | "password" | "serverRoles">, never>) | undefined;
...
export declare const UpdateUserRequest: {
    ...
    fromPartial<I extends {
        ...
        permissions?: ({
            ...
            databaseName?: string | undefined;
            roles?: (import("../../../../../yandex/cloud/mdb/sqlserver/v1/user").Permission_Role[] & import("../../../../../yandex/cloud/mdb/sqlserver/v1/user").Permission_Role[] & Record<Exclude<keyof I["permissions"][number]["roles"], "$type" | keyof import("../../../../../yandex/cloud/mdb/sqlserver/v1/user").Permission_Role[]>, never>) | undefined;
    ...
    } & Record<Exclude<keyof I, "$type" | "updateMask" | "permissions" | "clusterId" | "password" | "userName" | "serverRoles">, never>>(object: I): UpdateUserRequest;
};
