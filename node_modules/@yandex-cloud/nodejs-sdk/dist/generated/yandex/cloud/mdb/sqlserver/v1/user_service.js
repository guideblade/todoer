...
exports.UpdateUserRequest = {
    ...
    fromJSON(object) {
        ...
        message.serverRoles = ((_b = object.serverRoles) !== null && _b !== void 0 ? _b : []).map((e) => (0, user_1.serverRoleFromJSON)(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.serverRoles) {
            obj.serverRoles = message.serverRoles.map((e) => (0, user_1.serverRoleToJSON)(e));
        }
        else {
            obj.serverRoles = [];
        }
    ...
    fromPartial(object) {
        ...
        message.serverRoles = ((_e = object.serverRoles) === null || _e === void 0 ? void 0 : _e.map((e) => e)) || [];
        return message;
    },
};
