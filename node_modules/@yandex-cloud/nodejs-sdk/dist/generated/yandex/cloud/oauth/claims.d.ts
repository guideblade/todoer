...
export declare function subjectTypeFromJSON(object: any): SubjectType;
export declare function subjectTypeToJSON(object: SubjectType): string;
...
export declare const SubjectClaims: {
    ...
    } & Record<Exclude<keyof I, "$type" | "sub" | "name" | "email" | "picture" | "givenName" | "familyName" | "preferredUsername" | "zoneinfo" | "locale" | "phoneNumber" | "subType" | "federation">, never>>(object: I): SubjectClaims;
};
