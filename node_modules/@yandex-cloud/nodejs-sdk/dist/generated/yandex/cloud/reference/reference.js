...
exports.Reference = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, baseReference);
    ...
    fromJSON(object) {
        ...
        message.referrer =
            object.referrer !== undefined && object.referrer !== null
                ? exports.Referrer.fromJSON(object.referrer)
                : undefined;
        message.type =
    ...
    fromPartial(object) {
        ...
        message.referrer =
            object.referrer !== undefined && object.referrer !== null
                ? exports.Referrer.fromPartial(object.referrer)
                : undefined;
...
exports.Referrer = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseReferrer);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
