...
exports.Trigger_IoTBrokerMessage = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.batchSettings !== undefined) {
            exports.BatchSettings.encode(message.batchSettings, writer.uint32(26).fork()).ldelim();
        }
        if (message.invokeFunction !== undefined) {
            exports.InvokeFunctionWithRetry.encode(message.invokeFunction, writer.uint32(810).fork()).ldelim();
        }
...
exports.Trigger_ObjectStorage = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.batchSettings !== undefined) {
            exports.BatchSettings.encode(message.batchSettings, writer.uint32(66).fork()).ldelim();
        }
        if (message.invokeFunction !== undefined) {
            exports.InvokeFunctionWithRetry.encode(message.invokeFunction, writer.uint32(810).fork()).ldelim();
        }
...
exports.Trigger_ContainerRegistry = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.batchSettings !== undefined) {
            exports.BatchSettings.encode(message.batchSettings, writer.uint32(58).fork()).ldelim();
        }
        if (message.invokeFunction !== undefined) {
            exports.InvokeFunctionWithRetry.encode(message.invokeFunction, writer.uint32(810).fork()).ldelim();
        }
...
exports.Trigger_Logging = {
    ...
    fromJSON(object) {
        ...
        message.streamName = ((_c = object.streamName) !== null && _c !== void 0 ? _c : []).map((e) => String(e));
    ...
    fromPartial(object) {
        ...
        message.streamName = ((_d = object.streamName) === null || _d === void 0 ? void 0 : _d.map((e) => e)) || [];
        message.levels = ((_e = object.levels) === null || _e === void 0 ? void 0 : _e.map((e) => e)) || [];
        message.batchSettings =
            object.batchSettings !== undefined && object.batchSettings !== null
...
const baseObjectStorageBucketSettings = {
    $type: "yandex.cloud.serverless.triggers.v1.ObjectStorageBucketSettings",
    bucketId: "",
    serviceAccountId: "",
};
exports.ObjectStorageBucketSettings = {
    $type: "yandex.cloud.serverless.triggers.v1.ObjectStorageBucketSettings",
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.bucketId !== "") {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseObjectStorageBucketSettings);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
typeRegistry_1.messageTypeRegistry.set(exports.ObjectStorageBucketSettings.$type, exports.ObjectStorageBucketSettings);
const baseMail = {
...
exports.Mail = {
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.attachmentsBucket !== undefined) {
            exports.ObjectStorageBucketSettings.encode(message.attachmentsBucket, writer.uint32(34).fork()).ldelim();
        }
        if (message.invokeFunction !== undefined) {
            exports.InvokeFunctionWithRetry.encode(message.invokeFunction, writer.uint32(810).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.attachmentsBucket = exports.ObjectStorageBucketSettings.decode(reader, reader.uint32());
                    break;
                case 101:
                    message.invokeFunction = exports.InvokeFunctionWithRetry.decode(reader, reader.uint32());
                    break;
    ...
    fromJSON(object) {
        ...
        message.attachmentsBucket =
            object.attachmentsBucket !== undefined &&
                ...
                ? exports.ObjectStorageBucketSettings.fromJSON(object.attachmentsBucket)
                : undefined;
        message.invokeFunction =
            object.invokeFunction !== undefined && object.invokeFunction !== null
                ? exports.InvokeFunctionWithRetry.fromJSON(object.invokeFunction)
    ...
    toJSON(message) {
        ...
        message.attachmentsBucket !== undefined &&
            (obj.attachmentsBucket = message.attachmentsBucket
                ? exports.ObjectStorageBucketSettings.toJSON(message.attachmentsBucket)
                : undefined);
        message.invokeFunction !== undefined &&
            (obj.invokeFunction = message.invokeFunction
                ? exports.InvokeFunctionWithRetry.toJSON(message.invokeFunction)
    ...
    fromPartial(object) {
        ...
        message.attachmentsBucket =
            object.attachmentsBucket !== undefined &&
                object.attachmentsBucket !== null
                ? exports.ObjectStorageBucketSettings.fromPartial(object.attachmentsBucket)
                : undefined;
        message.invokeFunction =
            object.invokeFunction !== undefined && object.invokeFunction !== null
                ? exports.InvokeFunctionWithRetry.fromPartial(object.invokeFunction)
